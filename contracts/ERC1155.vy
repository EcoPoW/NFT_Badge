...
ERC1155_METADATA_INTERFACE_ID: constant(bytes32) = 0x000000000000000000000000000000000000000000000000000000000e89341c
...
def __init__():
    ...
    self.supportedInterfaces[ERC1155_METADATA_INTERFACE_ID] = True
...
def mint(
    ...
    assert _to != ZERO_ADDRESS
    self._balanceOf[_to][self.tokensIdCount] = _supply
...
def mintBatch(
    ...
    for i in range(BATCH_SIZE):
        self._balanceOf[_to][self.tokensIdCount] = _supplys[i]
        self.tokensIdCount += 1
...
@view
@external
def uri(tokenId: uint256) -> String[100]:
    return "https://www.w3connect.org/static/badge.json"
